 ...
 */
    ...
    [_NUMS] = LAYOUT( /* Left */
      ...
      _______, KC_A,    KC_B,    KC_C,    KC_D,    KC_E,    KC_F,    KC_4,    KC_5,    KC_6,    KC_MINS, KC_NUHS,
 ...
 */
    ...
    [_SYMB] = LAYOUT( /* Right */
      ...
      _______, TD_LBR,  _______, TD_RBR,  _______, _______, _______, _______, KC_UNDS, KC_PLUS, _______, KC_NUBS,
