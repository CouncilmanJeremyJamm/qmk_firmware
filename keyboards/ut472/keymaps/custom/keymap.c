...
LAYOUT(
  ...
  KC_LCTL, KC_LGUI, KC_LALT, KC_MEDIA_PLAY_PAUSE,MO(1), KC_SPC,  MO(2),  KC_LEFT, KC_DOWN,  KC_UP,   KC_RGHT
),
...
LAYOUT( /* Left */
  ...
  _______, RGB_TOG, RGB_MOD, RGB_VAI, RGB_VAD, _______, _______, KC_MINS, KC_EQL,  TD(LBRACS), TD(RBRACS), KC_BSLS,
...
LAYOUT( /* Right */
  KC_TILDE,  KC_EXCLAIM, KC_AT,  KC_HASH,  KC_DOLLAR, KC_PERCENT, KC_CIRCUMFLEX, KC_AMPERSAND, KC_ASTERISK, KC_MINS, KC_EQL, KC_DELETE,
  ...
  /* FN Layer 3
   * ,-------------------------------------------------------------------------.
   * | Esc | Calc|Webhm| Mail|Files|     |     |     |     |     |PrtSc|  Home |
   * |-------------------------------------------------------------------------+
   * |      |     |     |     |     |     |     |     |     |     |     | PgUp |
   * |-------------------------------------------------------------------------+
   * |       |     |     |     |     |     |     |     |     |     |     | PgDn|
   * |-------------------------------------------------------------------------+
   * |     |     |     |     |      |          |       |MousL|MousU|MousD|MousR|
   * `-------------------------------------------------------------------------'
   */

LAYOUT( /* Tab */
  KC_ESC,  KC_CALC, KC_WHOM, KC_MAIL, KC_MYCM, _______, _______, _______, _______, _______, KC_PSCR, KC_HOME,
  _______, RGB_TOG, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PGUP,
  _______, _______, _______, _______, _______,TD(TDRESET), _______, _______, _______, _______, _______, KC_PGDN,
  _______, _______, _______, _______, _______,     _______,      _______, KC_MS_L, KC_MS_U, KC_MS_D, KC_MS_R
),
};